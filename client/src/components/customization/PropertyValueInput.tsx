...
export function PropertyValueInput({
  ...
  const {
    ...
    queryKey: queryKeys.rulesets.propertyValueCompletions(rulesetId, propertyType, debouncedInputValue),
    queryFn: async ({ pageParam }) => {
      return parseResponse(rpc.api.rulesets[":id"].customization.properties.values.completions
        .$get({
          param: { id: rulesetId },
          query: {
            type: propertyType,
