...
Generated Skill Focus cleanup only deletes feats owned by the edited ruleset. Renaming or removing an inherited skill must never delete an ancestor’s generated feat.
